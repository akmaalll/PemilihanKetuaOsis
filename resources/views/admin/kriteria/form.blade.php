                        ...
                        <form id="kt_modal_new_target_form" class="form" action="#">
                            ...
                            <div class="row g-9 mb-8">
                                ...
                                <div class="col-md-6 fv-row">
                                    ...
                                    <input type="text" class="form-control" placeholder="Kriteria" name="kriteria"
                                        id="kriteria" value="{{ $data->kriteria ?? '' }}" />
                                </div>
                            </div>
                            ...
                            <div class="row g-9 mb-8">
                                <div class="col-md-6 fv-row">
                                    ...
                                    <input type="number" class="form-control" placeholder="Skor" name="poin"
                                        id="poin" value="{{ $data->poin ?? '' }}" />
                                </div>
                                <div class="col-md-6 fv-row">
                                    <label class="required fs-6 fw-semibold mb-2">Keterangan</label>
                                    <textarea name="ket" class="form-control" id="" cols="10" rows="5"></textarea>
                                </div>
                            </div>
                            <!--end::Input group-->
